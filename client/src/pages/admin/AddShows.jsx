  ...
  return nowPlayingMovies.length > 0 ?  (
    ...
    <div className='mt-6'>
      ...
      <div className='inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg'>
        ...
        <button onClick={handleDateTimeAdd} className='bg-[rgba(248,69,101,0.8)] text-white px-3 py-2 text-sm rounded-lg hover:bg-[var(--color-primary)] cursor-pointer'>Add Time</button>
      </div>
    </div>
