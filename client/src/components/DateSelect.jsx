...
const DateSelect = ({dateTime, id}) => {
  ...
  return (
    <div id='dateSelect' className='pt-30'>
        ...
        <button onClick={onBookHandler} className='bg-[color:var(--color-primary)] text-white px-8 py-2 mt-6 rounded hover:bg-[rgba(248,69,101,0.9)] transition-all cursor-pointer'>
            Book Now
        </button>
