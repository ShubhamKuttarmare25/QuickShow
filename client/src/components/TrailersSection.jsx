...
const TrailersSection = () => {
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden relative'> {/*added relative*/}
      <p className='text-gray-300 font-medium text-lg max-w-[960px] mx-auto'>Trailers</p>
      <BlurCircle top='-100px' right='-100px'/>   {/* top='-100px' right='-100px' this is not working*/}
      <div className='relative mt-6'>
        {/* There was a issue with the version, the latest version was not working with these urls, hence used the version 2.16.0 */}
